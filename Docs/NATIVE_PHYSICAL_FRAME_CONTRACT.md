...
live Device layout is `ScreenDeviceParametersV3`; catalog ABI 9 and test-authoring ABI 35 are
strict current-only companions to physical-frame ABI 24. The current executor
