...
live Device layout is `ScreenDeviceParametersV3`; catalog ABI 7 and test-authoring ABI 30 are
strict current-only companions to physical-frame ABI 18. The current executor
