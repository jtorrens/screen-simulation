...
live Device layout is `ScreenDeviceParametersV3`; catalog ABI 7 and test-authoring ABI 31 are
strict current-only companions to physical-frame ABI 19. The current executor
