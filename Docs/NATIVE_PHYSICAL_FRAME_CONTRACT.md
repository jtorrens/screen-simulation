...
live Device layout is `ScreenDeviceParametersV3`; catalog ABI 8 and test-authoring ABI 34 are
strict current-only companions to physical-frame ABI 23. The current executor
