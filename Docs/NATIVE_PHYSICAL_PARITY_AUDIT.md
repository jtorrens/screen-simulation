...
5. El único ABI v6 transporta `PanelLightSpreadProfile`, geometría relativa, cover/environment y camera/lens/sensor; no debe restaurarse una frontera insuficiente.
...
1. Mantener la materialización completa de `PanelLightSpreadProfile` del ABI v6 sin lookup de preset, adaptador o default implícito.
